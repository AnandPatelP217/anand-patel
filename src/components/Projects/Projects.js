...
import project1 from "../../images/alumni_connect.png"
      ...
      <hr/>
        ...
        <Col md={4} className="project-card">
            <ProjectCard
              imgPath={project1}
              isBlog={false}
              title="Alumni_Platform"
              description="Developed a  platform for the collage gradute (Alumni). "
              TechnologyUsed="MERN Stack"
              ghLink="https://github.com/AnandPatelP217/Alumnni_frontend.git"
              demoLink="#"
            />
          </Col>
          <Col md={4} className="project-card">
